    ...
    <body class="u-body" style="font-family: 'Tajawal', sans-serif;" dir="rtl">
        ...
        <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-end me-4 rotate-caret" id="sidenav-main">
            ...
            <div class="collapse navbar-collapse px-0 w-auto " id="sidenav-collapse-main">
                <ul class="navbar-nav" style="padding-right: 0vw;">
                    <li class="nav-item">
            ...
            <div class="container-fluid py-4">
                <div class="row my-2">
                    <div class="col-lg-12 col-md-6 mb-md-0 mb-4">
                        <div class="card p-2 m-4" style="height: 32vw;">
                                        ...
                                        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" enctype="multipart/form-data">
                                            <div class="tab-content" style="border-right: 2px #001B48;">
                                                ...
                                                <div class="tab-pane fade active show" id="account-general">
                                                    ...
                                                    <div class="card-body" style="margin-top: -1.5vw; padding: 3vw 2vw; overflow-y: scroll; height: 28vw;">
                                            ...
                                            <div class="text-right pt-2" style=" border-top: solid 0.1vw #E5E5EB; ">
                                                <button class="btn btn-primary" style="margin-right: 38vw;">حفظ التغييرات</button>
