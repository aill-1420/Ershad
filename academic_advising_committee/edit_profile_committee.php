...
$id = $_SESSION['userid'];
$query = "SELECT * FROM acadmic_advising_committee WHERE id = '$id'";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "UPDATE acadmic_advising_committee SET full_name='$name' , email='$updated_email' , phone_number='$phone' , password='$password' WHERE id = '$userId'";
    $mysql->query($query);
    $_SESSION['name'] = $name;
                            ...
                            <li class="mb-2">
                                <a class="dropdown-item border-radius-md" href="javascript:;">
                                    <div class="d-flex py-1">
                                        <div class="my-auto">
                                            <img src="../template/assets/images/team-2.jpg"
                            ...
                            <div class="col-md-3 pt-0">
                                <div class="list-group list-group-flush account-settings-links">
                                    <a class="list-group-item list-group-item-action active" data-toggle="list"
                                       href="#account-general">إعدادات عامة</a>
                                    ...
                                    <div class="tab-content" style="border-right: 2px #001B48;">
                                        ...
                                        <div class="tab-pane fade active show" id="account-general">
                                            ...
                                            <div class="card-body media align-items-center"
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-3">
                                                        <img src="<?php if ($info['profile_photo'] != NULL) echo '../template/assets/images/profile-user-grey.svg'; else echo '../template/upload/' . $info['profile_photo'] ?>"
                                                             alt="" class="d-block" style="width: 80%">
                                                    </div>
                                        ...
                                        <!--<div class="tab-pane fade" id="account-info">
                                            <div class="card-body pb-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" value="24-1-2000">
                                                </div>
                                            </div>
                                        ...
                                        <div style="height: 4.8vw;"></div>
                                    </div>
                                    <!--Start button page-->
                                    <div class="text-right mt-3">
                                        <button class="btn btn-primary">حفظ التغييرات</button>&nbsp;
                                        <button class="btn btn-default">إلغاء</button>
                                    </div>
                                    <!--End Info -->
