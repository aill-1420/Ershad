                ...
                <div class="container-fluid py-1 px-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 ">
                            ...
                            <li class="breadcrumb-item text-sm ps-2"><a class="opacity-5 text-white" href="students_List.php">الطلاب</a></li>
                            <li class="breadcrumb-item text-sm ps-2"><a class="opacity-5 text-white" href="complaints_List.php">الشكاوى المرسلة</a></li>
