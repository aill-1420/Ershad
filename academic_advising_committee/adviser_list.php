                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <div class="row mb-3">
                            <div class="col-12">
                                <h3>المرشدين</h3>
                                <!-- BUTTON for add new academic adviser  -->
                                <!--<button class="btn" onclick="openForm()"
                                        style="float: left; background-color: #D5EBEE;
                                                    margin: 0.4vw; padding: 0.5vw 0.7vw;">
                                    <i class="icm icon-plus" style="margin: 0.1vw 0.2vw; margin-bottom: 0vw;"></i> تعيين مرشد</button>-->
                    ...
                    </div><div class="content_detail__pagination cdp" actpage="1">
