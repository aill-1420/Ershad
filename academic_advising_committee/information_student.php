                        ...
                        <div class="row">
                            ...
                            <div class="col-2" style="margin-top: 0.8vw;">
                                <div class="d-flex flex-column h-100" style=" cursor: pointer;">
                                    <a class="btn" href="../student/view_advising_file.php?user=<?php echo $data['id'] ?>" style="background-color: #97CADB; color: white;      font-size: 15px;font-weight: 500; cursor: pointer; text-align-last: center; border-radius: 15px; padding: 0.5vw 0.2vw;"><i class="icm icon-folder_shared"></i> الملف الإرشادي</a>
                                </div>
                            </div>
                            <!--<div class="col-2" style="margin-top: 0.8vw;">
                                <div class="d-flex flex-column h-100" style=" cursor: pointer;">
                                    <a class="btn" href="metting_profile.php?id=<?php echo $data['id']?>" style="background-color: #97CADB; color: white; font-size:    15px;font-weight: 500; text-align-last: center; border-radius: 15px; padding: 0.5vw 0.2vw;"><i class="icm icon-file-text"></i> تقارير اللقاءات</a>
                                </div>
                            </div>-->
                        </div>
                        <div class="row">
