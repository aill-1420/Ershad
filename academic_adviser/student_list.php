...
$query = "SELECT * FROM students  WHERE adviser_id=".$_SESSION['userid'];
                    ...
                    <table id="list">
                        ...
                        <?php foreach($data as $student) { ?>
                            <tr>
                                ...
                                <td>غير متعثر</td>
                                <td><a class="tableBtn" href="information_student.php?user=<?php echo $student['id'] ?>"<i class="icm icon-folder_shared" style="color: #fff;">  </i>
                                    عرض</a>
                                </td>
                            </tr>
                        <?php } ?>
