...
<head>
    ...
    <style>
        ...
        .scheduleMeeting-container input[type=text], .scheduleMeeting-container input[type=date], .scheduleMeeting-container input[type=time] {
            width: 100%;
            padding: 0.5vw;
            margin: 5px 0 22px 0;
            border: none;
        ...
        .scheduleMeeting-container input[type=text]:focus, .scheduleMeeting-container input[type=date]:focus, .scheduleMeeting-container input[type=time]:focus {
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 ">
                    <li class="breadcrumb-item text-sm ps-2"><a class="opacity-5 text-white"
                                                                href="adviserDashboard.html">لوحة القيادة</a></li>
    ...
    <div class="container-fluid py-4">
        ...
        <div class="row my-4">
            <div class="col-lg-12 col-md-6 mb-md-0 mb-4">
                <div class="card" style="height: 35vw; display: block;">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-6 mb-md-0 mb-4">
                            <div class="card" style="padding: 0vw; height: 22vw; overflow-y: scroll;">
                                <table id="list">
                                    <tr>
                                        <th>رقم اللقاء</th>
                                        <th>التاريخ</th>
        ...
        <div class="scheduleMeeting-popup" id="scheduleMeetingPopUp">
            <form class="scheduleMeeting-container" method="POST"
                  style="height: 80%;"<?php echo $_SERVER["PHP_SELF"] ?>>
                <h3>إنشاء لقاء جديد</h3>

                <label for="date"><b>تاريخ ووقت اللقاء</b></label>
                <br>
                <input id="date" type="datetime-local" placeholder="dd/mm/yyyy" name="date" required>
                <br>
