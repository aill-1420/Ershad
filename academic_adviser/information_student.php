...
<head>
    ...
    <style>
        ...
        /*            تنسيق الازرار حق الملف الارشادي والتقارير*/
        .btn:hover {
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <div class="infromation-group">
                                    ...
                                    <div>
                                        <p class="group-content">وصايف السلمي</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card"  style="box-shadow: none;">
                                    <form  class="studentPlan-container" style="box-shadow: inset 0px 0px 5px #AEADBF;" method="POST" action="<?php echo $_SERVER['PHP_SELF'] ?>?user=<?php echo $data['id'] ?>">
                                        ...
                                        <div class="row">
                                            ...
                                            <button class="btn mt-4 mb-3">حفظ</button>
                ...
                <div class="card" style="padding-bottom: -5vw; margin-top: 1.3vw;">
                                    ...
                                    <div class="col-lg-12 me-auto ms-0">
                                        <div class="row">
                                            ...
                                            <div class="col-4" style="margin-top: 0.8vw;">
                                                <div class="d-flex flex-column h-100" style=" cursor: pointer;">
                                                    <a class="btn" onclick="popUpProfile()" style="background-color: #97CADB; color: white; font-size:    15px;font-weight: 500; text-align-last: center; border-radius: 15px; padding: 0.5vw 0.2vw; margin-top: -0.4vw;;"><i class="icm icon-plus"></i>  تقرير جديد </a>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="card" style="padding: 0vw; height: 14vw; overflow-y: scroll;">
                                                    <table id="list">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a class="tableBtn" href="../academic_advising_committee/metting_profile.php?id=<?php echo $r['id'] ?>"><i class="icm icon-folder_shared" style="color: #fff;"></i></a></td>
                                                        </tr>
                                                        <?php } ?>
                                                    </table>
                                                </div>
                    ...
                    <div class="form-popup" id="profile">
                        <form action="information_student.php" class="form-container" method="POST">
                            ...
                            <input id="profileTitle" type="text" placeholder="تقرير (1) dd-mm-yyyy" name="title" required>

                            <label for="profileContent"><b>محتوى التقرير</b></label>
                            <textarea id="profileContent" name="content" placeholder="أكتب المحتوى هنا ....." style="height: 50%;" required></textarea>
                            ...
                            <div class="row" style="margin-right: 1vw;;">
                                ...
                                <div class="col-5 mb-lg-0 mb-4" style="margin: 1vw;">
                                    <button class="btn cancel" onclick="closeProfile()">إلغاء</button>
                                </div>
                            </div>
                        </form>
                    </div>
