...
<header class="u-clearfix u-header u-sticky u-sticky-5894 u-header" id="sec-92d8"
        style="direction: rtl;background-color: white; box-shadow: 1px 1px 6px #AEADBF; height: 5vw; padding-right: 2vw;">
    <!-- Start Logo -->
    ...
    <div class="u-clearfix u-sheet u-sheet-1" style="top: -2.5vw; z-index: 30;">
        ...
        <!--<div class="input-group"
             style="direction: ltr; width: 20%;  margin-top: -3.4vw; float: left; box-shadow: 0px 0px 2px #AEADBF; z-index: 30;">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur"
         data-scroll="false" style="top: -8.8vw; z-index: 20;">
        ...
        <ul class="navbar-nav me-auto ms-0 justify-content-end" style="margin-top: -0.3vw;">
            ...
            <li class="nav-item dropdown ps-2 d-flex align-items-center icon-lg">
                <a href="javascript:;" class="nav-link text-success font-weight-bold px-2" id="dropdownMenuButton"
                ...
                <ul class="dropdown-menu  px-2 py-3 me-sm-n4" aria-labelledby="dropdownMenuButton">
                    ...
                    <li class="mb-2">
                        <a class="dropdown-item border-radius-md" href="javascript:;">
                            <div class="d-flex py-1">
                                <div class="my-auto">
                                    <img src="../assets/images/logo-spotify.svg"
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-2">
                        <div class="tabBtn" id="edit">
                            <a onclick="openForm()">
                                <button class="tablinks"><i class="icm icon-check" style="font-size: 24px;"></i> حفظ
                                </button>
                            </a>
                        </div>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-3">
                                        <div class="infromation-groupForm">
                                            ...
                                            <input class="group-content" id="studentName"
                                                   placeholder="سحر عبدالله الزهراني">
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="infromation-groupForm">
                                            <label class="group-title">تاريخ الميلاد</label>
                                            <input class="group-content" type="date" name="date_birthday"
                                                   id="studentDateOfBirth" placeholder="24-1-2000">
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="infromation-groupForm">
                                            <label class="group-title">الجنسية</label>
                                            <input type="text" class="group-content" name="nationality"
                                                   placeholder="سعودي">
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="infromation-groupForm">
                                            ...
                                            <input class="group-content" name="address" id="studentAddress"
                                                   placeholder="بطحاء قريش-مكة الكرمة">
                                        </div>
                                    </div>
                                </div>
                                <!-- End row 1 -->
                    ...
                    <div class="card-body p-3">
                        <div class="informationForm">
                            ...
                            <div class="row">
                                <div class="col-3">
                                    <div class="infromation-groupForm">
                                        <label class="group-title">الاضطرابات أو المتلازمات النفسية</label>
                                        <input class="group-content" name="psychiatric_disorders__syndromes"
                                               id="psychiatricSyndromes"
                                               placeholder="اكتئاب، نقص الانتباه، صعوبات التعلم">
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="infromation-groupForm">
                                        <label class="group-title">الأمراض المستعصية</label>
                                        <input class="group-content" name="incurable_diseases" id="incurableDiseases"
                                               placeholder="أورام سرطانية، نقص المناعة">
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="infromation-groupForm">
                                        <label class="group-title">الأمراض المزمنة</label>
                                        <input class="group-content" name="chronic_diseases" id="chronicDiseases"
                                ...
                                <div class="col-3">
                                    <div class="infromation-groupForm">
                                        ...
                                        <input class="group-content" name="special_care" id="specialCare"
                                               placeholder="لا">
                                    </div>
                                </div>
                            </div>
            ...
            <div class="card p-0" id="cardForm2">
                ...
                <div class="card-body p-3">
                    <div class="informationForm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                <div class="infromation-groupForm">
                                    ...
                                    <input class="group-content" type="number" name="number_brother_sister"
                                           id="numberOfBrothers" placeholder="6">
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="infromation-groupForm">
                                    <label class="group-title">ترتيب الطالب بين اخوته</label>
                                    <input class="group-content" type="number" name="order_student_on_family"
                                           id="studentRank" placeholder="2">
                                </div>
                            </div>
                        </div>
                        <!-- End row 1 -->
                        ...
                        <div class="row">
                            <div class="col-3">
                                <div class="infromation-groupForm">
                                    ...
                                    <input class="group-content" id="ParentsSocialStatus" name="Parents_status"
                                           placeholder="مستقران">
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="infromation-groupForm">
                                    ...
                                    <input class="group-content" id="educationalLevelOfFather"
                                           name="Father_educational_level" placeholder="بكالوريوس">
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="infromation-groupForm">
                                    <label class="group-title">المستوى التعليمي للأم</label>
                                    <input class="group-content" id="educationalLevelOfMother"
                                           name="Mother_educational_level" placeholder="بكالوريوس">
                                </div>
                            </div>
                        </div>
                        <!-- End row 2 -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                <div class="infromation-groupForm">
                                    ...
                                    <input class="group-content" id="injured" name="injured_the_southern_border"
                                           placeholder="لا">
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- Start row 4 -->
                        <div class="row">
                            <p style="margin-top: 1vw; color: red;">في حال كون الأب ليس على قيد الحياة، اجب عن
                                التالي</p>
                            <div class="col-3">
                                <div class="infromation-groupForm">
                    ...
                    <div class="row">
                        <div class="col-3">
                            <div class="infromation-groupForm">
                                ...
                                <input class="group-content" id="fatherProfession" name="father_profession"
                                       placeholder="مهندس">
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="infromation-groupForm">
                                ...
                                <input class="group-content" id="MotherProfession" name="mother_job"
                                       placeholder="معلمة">
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="infromation-groupForm">
                                ...
                                <input class="group-content" id="familyIncome" name="family_income"
                                       placeholder="10,000">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-3">
                            <div class="infromation-groupForm">
                                ...
                                <input class="group-content" id="homeOwnership" name="house_ownership"
                                       placeholder="إيجار">
                            </div>
                        </div>
                    </div>
