...
================================================== */
    ...
    function openForm(){
        ...
        document.getElementById("cardView1").style.display= "none";
        document.getElementById("cardForm1").style.display= "block";
        document.getElementById("cardView2").style.display= "none";
        document.getElementById("cardForm2").style.display= "block";
        document.getElementById("cardView3").style.display= "none";
        document.getElementById("cardForm3").style.display= "block";
    ...
    function saveForm(){
        ...
        document.getElementById("cardForm1").style.display= "none";
        document.getElementById("cardView1").style.display= "block";
        document.getElementById("cardForm2").style.display= "none";
        document.getElementById("cardView2").style.display= "block";
        document.getElementById("cardForm3").style.display= "none";
        document.getElementById("cardView3").style.display= "block";
