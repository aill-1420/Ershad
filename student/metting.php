                            ...
                            <a class="dropdown-item border-radius-md" href="javascript:;">
                                <div class="d-flex py-1">
                                    ...
                                    <div class="d-flex flex-column justify-content-center">
                                        <h6 class="text-sm font-weight-normal mb-1"><span class="font-weight-bold">New message</span>
                                            from Laur</h6>
                        ...
                        <li class="mb-2">
                            <a class="dropdown-item border-radius-md" href="javascript:;">
                                <div class="d-flex py-1">
                                    ...
                                    <div class="d-flex flex-column justify-content-center">
                                        <h6 class="text-sm font-weight-normal mb-1"><span class="font-weight-bold">New album</span>
                                            by Travis Scott</h6>
                            ...
                            <a class="dropdown-item border-radius-md" href="javascript:;">
                                <div class="d-flex py-1">
                                    ...
                                    <div class="d-flex flex-column justify-content-center">
                                        ...
                                        <p class="text-xs text-secondary mb-0"><i class="fa fa-clock me-1"></i>2 days
                                        </p>
                                    </div>
                                </div>
                            </a>
    ...
    <div class="container-fluid py-4">
        ...
        <div class="row my-4">
            <div class="col-lg-12 col-md-6 mb-md-0 mb-4">
                <div class="card" style="padding: 0vw; ">
                    <table id="list">
                        <tr>
                            <th>رقم اللقاء</th>
                            <th>التاريخ</th>
                        ...
                        <?php if ($id >= 1) { ?>
                            <?php foreach ($data as $m) { ?>
                                <tr>
                                    <td><?php echo $m['id'] ?></td>
                                    <td><?php $time = new DateTime($m['date_time']);
                                        echo $time->format('d-m-Y'); ?></td>
                                    <td><?php $time = new DateTime($m['date_time']);
                                        echo $time->format('h:i:s A'); ?></td>
                                    <td><?php echo $m['duration'] ?> دقيقة</td>
                                    <td><?php echo $m['place'] ?></td>
                                    <?php
                                    $id = $m['id'];
                                    $query = "SELECT * FROM reservation WHERE student_id ='$user' AND metting_id = '$id'";
                                    if($mysql->query($query)->num_rows == 0) {
                                    ?>
                                    <td><a class="tableBtn" href="?reserve=<?php echo $m['id'] ?>"><i
                                                    class="icm icon-check" style="color: #fff;"> </i></a></td>
                                    <?php } else { ?>
                                                                            <td>تم الحجز</td>
                                    <?php }?>
                                </tr>
...
<!-- Start Footer-->
<section class="u-backlink u-clearfix u-grey-80" dir="rtl" style="position: fixed; width: 100%; bottom: 0vw;">
    <p class="u-text">
