...
<html len="ar">
    ...
    <body class="u-body" style="font-family: 'Tajawal', sans-serif;" dir="rtl">
        ...
        <div class="container light-style flex-grow-1 container-p-y">
            <!--page title-->
            <h4 class="font-weight-bold py-3 mb-1">الإعدادات الشخصية</h4>
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" enctype="multipart/form-data">
                            <div class="tab-content" style="border-right: 2px #001B48;">
                                ...
                                <div class="tab-pane fade active show" id="account-general">
                                    <div class="card-body" style="margin-top: -1.5vw; padding-top: 3vw;">
        ...
        <!-- Start Footer-->
        <section class="u-backlink u-clearfix u-grey-80" dir="rtl" style="margin-top: 2vw;">
            <p class="u-text">
